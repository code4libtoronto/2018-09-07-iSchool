...
venue: "University of Toronto iSchool"        # brief name of host site without address (e.g., "Euphoric State University")
address: "Faculty of Information, University of Toronto, Room 507, Claude Bissell Building, 140 St. George Street, Toronto, ON M5S 3G6"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria")
...
latlng: "43.665060,-79.399350"       # decimal latitude and longitude of workshop venue (e.g., "41.7901128,-87.6007318" - use https://www.latlong.net/)
humandate: "September 7, 2018"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
humantime: "10:00 am - 3:00 pm"    # human-readable times for the workshop (e.g., "9:00 am - 4:30 pm")
startdate: 2018-09-07      # machine-readable start date for the workshop in YYYY-MM-DD format like 2015-01-01
enddate: 2018-09-07        # machine-readable end date for the workshop in YYYY-MM-DD format like 2015-01-02
instructor: ["Thomas Guignard"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Kaitlin Newson", "Andrew Murphy", "Dawn Walker", "Kathy Chung", "Christoph Becker", "Matt Ratto"] 
email: ["thomas.guignard@gmail.com"]    # boxed, comma-separated list of contact email addresses for the host, lead instructor, or whoever else is handling questions, like ["marlyn.wescoff@example.org", "fran.bilas@example.org", "ruth.lichterman@example.org"]
collaborative_notes:  https://pad.carpentries.org/2018-09-07-iSchool           # optional: URL for the workshop collaborative notes, e.g. an Etherpad or Google Docs document
